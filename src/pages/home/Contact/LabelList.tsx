...
import { Button, Drawer, Empty, message, Tag } from "antd";
...
const LabelList = () => {
  ...
  const drawerConfirm = () => {
    ...
    if (preUpdateStatus.state) {
      ...
      if (tags.find((tag) => tag.tagName === tagName)) {
    ...
    <div className="label_list">
      ...
      >
        <div className="createDrawerContent">
          ...
          <Button type="primary" onClick={drawerConfirm} className="btn">
            {t("Confirm")}
          </Button>
        </div>
      </Drawer>
